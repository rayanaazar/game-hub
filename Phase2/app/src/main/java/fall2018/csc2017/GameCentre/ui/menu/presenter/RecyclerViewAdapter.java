...
import fall2018.csc2017.GameCentre.ui.menu.view.MainFragment;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private MenuContract.View menu;

    public RecyclerViewAdapter(Context context, ArrayList<String> games, ArrayList<String> gameImages, MainFragment mainFragment) {
        this.games = games;
        this.imagesForGames = gameImages;
        this.menu = mainFragment;
